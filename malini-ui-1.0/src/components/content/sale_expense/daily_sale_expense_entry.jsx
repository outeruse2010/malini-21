...
const expense_table = (expense_arr) => {
    ...
    return (
        <Modal open={openSaleExpenseModal} onClose={toggleSaleExpenseModal}  size='small'  className={classes.modal} >
                <Fade in={openSaleExpenseModal}>
                    <div className={classes.paper}>
                        <ModalHeader header={action + ' Sale/Expense'} toggleModal={toggleSaleExpenseModal}/>

                        <Stack  component="form"  onSubmit={onSubmit} onReset={onReset}  spacing={2}  noValidate  autoComplete="off"  width={500}>
                            ...
                            <Grid container spacing={1}>
                                <Grid item xs={(action === 'Add New') ? 9 : 12}>
