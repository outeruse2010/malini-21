...
const expense_table = (expense_arr) => {
    ...
    return (
        <Modal open={openExpenseModal} onClose={toggleExpenseModal}  size='small'  className={classes.modal} >
                <Fade in={openExpenseModal}>
                    <div className={classes.paper}>
                        <ModalHeader header={action + ' Sale/Expense'} toggleModal={toggleExpenseModal}/>
  
                        <Stack  component="form"  onSubmit={onSubmit} onReset={onReset}  spacing={2}  noValidate  autoComplete="off"  width={450} >
